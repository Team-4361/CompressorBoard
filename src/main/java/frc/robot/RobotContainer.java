...
import frc.robot.commands.DisableCompressorCMD;
import frc.robot.commands.EnableCompressorCMD;
import frc.robot.commands.ExtendPistonCMD;
...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        aButton.whenPressed(new DisableCompressorCMD());
        bButton.whenPressed(new EnableCompressorCMD());
        yButton.whenHeld(new ExtendPistonCMD());
    }
}
